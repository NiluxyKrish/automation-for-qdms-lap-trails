...
public class CommonMethods extends DriverIntialization {
  ...
  public static void setElementProperties(WebElement ielement, String iWebPageName,
      String iWebElementName, String iXlocation, int iXSheetNumber, int iXRowNumber) {
    /**
     * 
     * This method is used to set the properties of a given web element and write them to an excel
     * sheet. The method takes in the following parameters:
     * 
     ...
     * @param iXRowNumber Row number to start writing the properties in Excel sheet. The method
     *        performs the following operations: Writes the Web page Name and Web element Name to
     *        the Excel sheet Sets the properties of the WebElement Writes each property and its
     *        value to the Excel sheet in the given row number The properties include: Common -
     *        Visibility, Common - Enability, JS - Hidden, JS - Disabled, Size, Position, Background
     *        - color, Font - color, Border - color, Font - type, Font - size, Text, Box - shadow,
     *        Padding
     */
  ...
  public static void checkElementProperties(WebElement ielement, String iXlocation,
      int iXSheetNumber, int iXRowNumber) {
     ...
     * 
     * @param iXlocation the location of the Excel sheet containing the test cases
     * 
     * @param iXSheetNumber the sheet number of the Excel sheet containing the test cases
     * 
    ...
    if (element == null) {
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Common - Visiblity",
              ExpectedProperty, "NO ELEMENT");
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Common - Enability ",
              ExpectedProperty, "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": JS - Hidden ", ExpectedProperty,
              "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": JS - Hidden  - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Size ", ExpectedProperty,
              "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Size  - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Position ", ExpectedProperty,
              "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Position  - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Background - color ",
              ExpectedProperty, "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Font - color ", ExpectedProperty,
              "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Font - color  - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Size ", ExpectedProperty,
              "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Font-Size - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Text (spelling) ",
              ExpectedProperty, "NO ELEMENT");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          ...
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Box Shadow - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Padding ", ExpectedProperty,
              "NO ELEMENT AVAIALABLE");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Padding - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Cursor ", ExpectedProperty,
              "NO ELEMENT AVAIALABLE");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Cursor - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null")) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Border Radius ", ExpectedProperty,
              "NO ELEMENT AVAIALABLE");
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Border Radius - expected:-" + ExpectedProperty + " actual:- " + null);
        }
      }
      DoTest = ExpectedProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          ...
          System.out.println(
              "Testing " + WebPageName + ": " + WebElementName + ": Common - Visiblity - expected:-"
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Common - Enability ",
              ExpectedProperty, ActualProperty);
          System.out.println(
              "Testing " + WebPageName + ": " + WebElementName + ": Common - Enability - expected:-"
                  + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": JS - Hidden ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": JS - Hidden  - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Size ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Size  - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Position ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Position  - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Background - color ",
              ExpectedProperty, ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Background - color  - expected:-" + ExpectedProperty + " actual:- "
              + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Font - color ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Font - color  - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Border - color ", ExpectedProperty,
              ActualProperty);
          System.out.println(
              "Testing " + WebPageName + ": " + WebElementName + ": Border - color  - expected:-"
                  + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Type ", ExpectedProperty,
              ActualProperty);
          System.out.println(
              "Testing " + WebPageName + ": " + WebElementName + ": Font-Type - color  - expected:-"
                  + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Font-Size ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Font-Size - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals("null")
          ...
          TestCasePrint(WebPageName + ": " + WebElementName + ": Text (spelling) ",
              ExpectedProperty, ActualProperty);
          System.out.println(
              "Testing " + WebPageName + ": " + WebElementName + ": Text (spelling) - expected:-"
                  + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Box Shadow ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Box Shadow - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Padding ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Padding - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Cursor ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Cursor - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
      ...
      if (DoTest.equals("true") || DoTest.equals("")) {
        if (!ExpectedProperty.equals("null") || !ExpectedProperty.equals(ActualProperty)) {
          TestCasePrint(WebPageName + ": " + WebElementName + ": Border Radius ", ExpectedProperty,
              ActualProperty);
          System.out.println("Testing " + WebPageName + ": " + WebElementName
              + ": Border Radius - expected:-" + ExpectedProperty + " actual:- " + ActualProperty);
        }
      }
      DoTest = ExpectedProperty = ActualProperty = "";
  ...
  public static void ExcelSheetWrite(String location, int sheetnum, int rownum, int columnnum,
      String printstatus) {
    /**
     * 
     * This method is used to write a string value to an Excel file at a specified location, sheet
  ...
  public static String ExcelSheetValue(String location, int sheetnum, int rownum, int columnnum) {
    /**
     * 
     * This method retrieves the cell value at a specified location in an Excel workbook.
     * 
     ...
     * 
     * @throws IOException if the file at the specified location cannot be read
     * 
  ...
  public static void ExcelSheetColor(String location, int sheetnum, int rownum, int columnnum,
      String cellcolor) {
    /*
     * Method Name: ExcelSheetColor
     * 
     * Description: This method is used to change the background color of a particular cell in an
     * Excel sheet. It takes as input the location of the Excel file, sheet number, row number,
     * column number, and cell color. It then creates a workbook and a sheet object, gets the
     * specified row and column, creates a new cell if it is null and sets its background color to
     * the specified value. The method then writes the changes to the Excel file.
     * 
     * Parameters:
     * 
     * location (String) - the file path of the Excel file sheetnum (int) - the index number of the
     * sheet in the Excel file (starting from 1) rownum (int) - the index number of the row in the
     * sheet (starting from 1) columnnum (int) - the index number of the column in the row (starting
     * from 1) cellcolor (String) - the color to be set as the background of the cell (options are
     * "red", "green", or "white") Return Value: This method does not return any value.
     * 
     * Exceptions:
     * 
     * If any exception occurs during the execution of this method, it prints the stack trace of the
     * exception.
     * 
     */
  ...
  public static String ExcelSheetValue(String location, String sheetname, int rownum,
      int columnnum) {
    /**
     * 
     * This method retrieves the cell value at a specified location in an Excel workbook.
