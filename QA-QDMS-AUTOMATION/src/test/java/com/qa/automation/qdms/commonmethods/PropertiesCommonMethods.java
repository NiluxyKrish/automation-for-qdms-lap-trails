...
public class PropertiesCommonMethods extends DriverIntialization {
   ...
   * @param definition :-About Test type(button name/ text name......)
   * @author :-Quenthan
   * @category :-Test Report
   */
  // Test reports For Properties
  public static void TestReportsq(String TestCaseName, Object expectedValue, Object actualValue,
      String definition) {
    /*********************************************************************************************************
   ...
   * @param Excal Sheet Property Data Must Be Blow Order In Column number 3-18 :- Visible, Enable,
   *        button Hight, button Width, xPostion, yPostion, Background Color, fontColour,
   *        borderColor, fontType, fontSize, CheckSpelling, boxShadow, Padding, Cursor, Opacity,
   *        FontWeight
   * 
   * @category Button Properties
   */
  // Button Properties
  public static void getButtonPropertiesq(String excelName, String sheetName, String uniqueId,
      WebElement finder, String definition) {
    ...
    try {
      ...
      PropertiesCommonMethods.TestReportsq(
          "Button Properties Test Fail⚠️- Check file Location or File name❗", "Get Propertis",
          "Fail Get Properties", definition);
    }
    ...
    if (isVisible == true) {
      ...
      if (isEnabled == true) {
        ...
        PropertiesCommonMethods.TestReportsq("7.Button Backround Colour", bgCol, backgroundColor,
            definition);

        String fontColour = finder.getCssValue("color");
        PropertiesCommonMethods.TestReportsq("8.Button Font Text colour", ftCol, fontColour,
            definition);

        String borderColor = finder.getCssValue("border-color");
        PropertiesCommonMethods.TestReportsq("9.Button Border Colour", bodCol, borderColor,
            definition);

        String fontType = finder.getCssValue("font-family");
        PropertiesCommonMethods.TestReportsq("10.Button Text Font Types", ftTy, fontType,
            definition);

        String fontSize = finder.getCssValue("font-Size");
        PropertiesCommonMethods.TestReportsq("11.Button Text Font-Size", ftSize, fontSize,
            definition);

        String checkSpelling = finder.getText();
        PropertiesCommonMethods.TestReportsq("12.Button Check Button Text Spelling", btTextSp,
            checkSpelling, definition);

        String boxShadow = finder.getCssValue("box-shadow");
        PropertiesCommonMethods.TestReportsq("13.Button Box Shadow", bBoxShw, boxShadow,
            definition);
        ...
        PropertiesCommonMethods.TestReportsq("17.Button Font Weight", btFotWt, fontWeight,
            definition);
      }

      else {
        PropertiesCommonMethods.TestReportsq(
            "Button Is Not Enabled❗Properties Checking Terminated⚠️", "Button Disabled",
            "Button Enabled", definition);
   ...
   * @param finder :- WebElement of Text :-@FindBy(xpath,id,name,classname.....)
   * @param definition :- Define Test(Types,module name, )
   * @param Excal Sheet Property Data Must Be Blow Order In Row number 2-16 :- Search Box
   *        Visibility, Search Box Enablity, Search Box border-color, Search Box Hight, Search Box
   *        Width, Search Box xPosition, Search Box yPosition, Search Box background color, Search
   *        Box cursor-pointer, Search Box overflow, Search Box margin, Search Box z-index, Search
   *        Box content, Inside Of Modal, Outside Of Modal
   * @category Button Properties
   */
  // Search Box Properties
  public static void searchBoxPropertiesq(String excelFileName, String sheetName, int I,
      WebElement finder, String definition) {
    ...
    try {
      ...
      // TODO: handle exception
      PropertiesCommonMethods.TestReportsq(
          "Search Box Properties Test Fail⚠️- Check file Location or File name❗", "Get Propertis",
          "Fail Get Properties", definition);
    }
    ...
    if (isVisible == true) {
      ...
      if (isEnabled == true) {
        ...
        String backgroundColor = finder.getCssValue("background-color");
        PropertiesCommonMethods.TestReportsq("8.Serach Box Background Color", Et, backgroundColor,
            definition);

        // Modal cursor-pointer
        String fontColour = finder.getCssValue("cursor");
        PropertiesCommonMethods.TestReportsq("9.Serach Box Cursor Pointer", nIn, fontColour,
            definition);
        ...
        PropertiesCommonMethods.TestReportsq("14.Serach Box After Click Inside Of Box", fteen,
            inClick, definition);
        ...
        PropertiesCommonMethods.TestReportsq("After Click Outside Of Box", fivteen, outside,
            definition);
        ...
        PropertiesCommonMethods.TestReportsq(
            "Search Box Is Not Enabled❗Properties Checking Terminated⚠️", "Modal Disabled",
            "Modal Enabled", definition);
      ...
      PropertiesCommonMethods.TestReportsq(
          "Search Box Is Not Visible❗Properties Checking Terminated⚠️", "Modal Displayed",
          "Modal Not Displayed", definition);
    }
   ...
   * @param finder :-WebElement of Text :-@FindBy(xpath,id,name,classname.....)
   * @param definition :- Define Test(Types,module name, ) Excal Sheet Property Data Must Be Blow
   *        Order In Row number 2-21:- Visibility, Enablity, Text Align, Padding, xPosition,
   *        yPosition, Text-Line-Height, Font-color, Text-Transformation, Font-style , Font-size,
   *        Check Text Spelling, Text Margin, Text Shadow, Word Spacing, Text-Decoration, Letter
   *        Spacing, Text-Vertical -Alignment, Text -Indent, Text -Orientation, Font-Family
   * 
   */
  // Text Properties
  public static void getTextPropertiesq(String excelFileName, String sheetName, int I,
      WebElement finder, String definition) {
    ...
    try {
      ...
      // TODO: handle exception
      PropertiesCommonMethods.TestReportsq(
          "Text Properties Test Fail⚠️- Check file Location or File name❗", "Get Propertis",
          "Fail Get Properties", definition);
    }
    ...
    if (isVisible == true) {
      ...
      if (isEnabled == true) {
        ...
        PropertiesCommonMethods.TestReportsq("7.Text Line-Height", bgCol, backgroundColor,
            definition);
        ...
        PropertiesCommonMethods.TestReportsq("9.Text Transformation", bodCol, borderColor,
            definition);
        ...
        // Text-spelling
        String checkSpelling = finder.getText();
        PropertiesCommonMethods.TestReportsq("12.Text Text Spelling", btTextSp, checkSpelling,
            definition);
        ...
        PropertiesCommonMethods.TestReportsq("17.Text Letter Spacing", btFotWt, fontWeight,
            definition);
  ...
  public static void cTestReports(String TestCaseName, Object expectedValue, Object actualValue,
      String definition) {
    boolean position = true;
    ExtentTest testCase = extent.createTest(TestCaseName);
    Object myvalue = null;
   ...
   * @param finder :-WebElement of Text :-@FindBy(xpath,id,name,classname.....)
   * @param definition :-Define Test(Types,module name, )
   * @param Excal Sheet Property Data Must Be Blow Order In Column C-L :- Visibilitty, Enablity,
   *        Icon fill color, Icon Hight, Icon Width, x- position, y- position, Icon background
   *        color, Cursor-pointer
   */
  public static void getIconPPt(String excelFileName, String sheetName, String testCaseNo,
      WebElement finder, String definition) {
    ...
    try {
      ...
      // TODO: handle exception
      PropertiesCommonMethods.TestReportsq(
          "Icon Properties Test Fail⚠️- Check file Location or File name❗", "Get Propertis",
          "Fail Get Properties", definition);
    }
    ...
    if (isVisible == true) {
      ...
      if (isEnabled == true) {
        ...
        String backgroundColor = finder.getCssValue("background-color");
        PropertiesCommonMethods.TestReportsq("8.Icon Background color", Et, backgroundColor,
            definition);
