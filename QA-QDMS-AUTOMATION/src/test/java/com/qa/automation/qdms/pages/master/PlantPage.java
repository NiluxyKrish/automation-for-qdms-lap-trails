...
public class PlantPage {
  ...
  @FindBy(
      xpath = "//span[@class='ant-dropdown-trigger ant-table-filter-trigger ant-dropdown-open']")
  public static WebElement search;
  ...
  @FindBy(
      xpath = "//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/div/div[2]/div[1]/table/thead/tr/th[1]/div/span[2]")
  public static WebElement searchicon;
  // *[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/div/div[2]/div[1]/table/thead/tr/th[2]/div/span[2]
  ...
  @FindBy(
      xpath = "//div[contains(@name,'sub_business_unit')]//div[contains(@class,'ant-select-selector')]")
  ...
  // @FindBy(xpath = "//ul[@class='ant-menu-overflow ant-menu ant-menu-root ant-menu-horizontal
  // ant-menu-dark']/div/div[2]/div/div/span[@class='ant-tag ant-tag-has-color']")
  // public static WebElement admin ;
  ...
  @FindBy(
      xpath = "//button[@type='button'][@class='ant-btn ant-btn-danger ant-btn-background-ghost']")
  ...
  @FindBy(
      xpath = "//ul[@class='ant-pagination mini ant-table-pagination ant-table-pagination-right']/li/div")
  ...
  @FindBy(
      xpath = "//li[@title='1'][@class='ant-pagination-item ant-pagination-item-1 ant-pagination-item-active']")
  public static WebElement DefaultPaginationPage;

  @FindBy(
      xpath = "//li[@title='2'][@class='ant-pagination-item ant-pagination-item-2 ant-pagination-item-active']")
  ...
  @FindBy(
      xpath = "//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/div/div[2]/div[1]/table/thead/tr/th[4]/div/span[2]")
  public static WebElement plantmanagersearch;
  ...
  @FindBy(
      xpath = "//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/div/div[2]/div[1]/table/thead/tr/th[3]/div/span[2]")
  public static WebElement sbusearch;
  ...
  @FindBy(
      xpath = "//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/div/div[2]/div[1]/table/thead/tr/th[6]/div/span[2]")
  public static WebElement contactnosearch;
  ...
  @FindBy(
      xpath = "//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/ul/li[1]")
  ...
  @FindBy(
      xpath = "//*[@id=\"root\"]/div/section/section/main/div/div/div[2]/div/div/div/div/div/div[2]/div[2]/table/tbody/tr[2]/td[2]")
  public static WebElement planttable;
  @FindBy(
      xpath = "(//li[contains(@class, 'ant-pagination-item') and not(contains(@class, 'ant-pagination-item-74'))])[last()]")
  ...
  @FindBy(
      xpath = "/html/body/div[3]/div/div[2]/div/div[2]/div[2]/form/div[3]/div[2]/div/div[1]/div/span[2]")
  ...
  @FindBy(
      xpath = "//span[@class='ant-dropdown-trigger ant-table-filter-trigger ant-dropdown-open']//span[@aria-label='search']")
